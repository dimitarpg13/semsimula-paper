...
- Wall-clock time: 1652s
- Final train loss: 4.7178
- Final val loss: 5.3091 (ppl 202.16)
- Final mass: mean=1.3564, std=0.1818, min=1.0799, max=1.7748
- Final gamma: 5.0000 (fixed at 5.0)
- Loss curve: `splm_sarfmass_logfreq_shakespeare_gamma5p00_loss_curve.png`
- Checkpoint: `splm_sarfmass_logfreq_shakespeare_gamma5p00_ckpt_latest.pt`
- Log: `splm_sarfmass_logfreq_shakespeare_gamma5p00_training_log.jsonl`
