...
- Wall-clock time: 2772s
- Final train loss: 4.2637
- Final val loss: 4.9702 (ppl 144.06)
- Final mass: mean=1.3124, std=0.1763, min=1.0445, max=1.7188
- Final gamma: 0.3000 (fixed at 0.3)
- Loss curve: `splm_sarfmass_logfreq_shakespeare_gamma0p30_loss_curve.png`
- Checkpoint: `splm_sarfmass_logfreq_shakespeare_gamma0p30_ckpt_latest.pt`
- Log: `splm_sarfmass_logfreq_shakespeare_gamma0p30_training_log.jsonl`
