# Token-direction diagnostics -- shakespeare_ckpt_latest
...
- TRAIN pooled $R^2$ = **+0.628**
- TEST pooled $R^2$  = **+0.562**

| layer | A. static null | B. velocity-only | C. velocity + shared $V_\psi$ | C - B |
|--:|--:|--:|--:|--:|
| 0 | -0.000 | +0.274 | +0.449 | +0.174 |
| 1 | -0.000 | +0.271 | +0.463 | +0.192 |
| 2 | -0.000 | +0.256 | +0.506 | +0.250 |
| 3 | -0.000 | +0.258 | +0.552 | +0.294 |
| 4 | -0.000 | +0.270 | +0.576 | +0.306 |
| 5 | -0.000 | +0.248 | +0.566 | +0.318 |
| 6 | -0.000 | +0.273 | +0.563 | +0.290 |
| 7 | -0.000 | +0.273 | +0.562 | +0.289 |
| 8 | -0.000 | +0.264 | +0.558 | +0.294 |
...
- `tokdir_shakespeare_ckpt_latest_results.npz`
- `tokdir_shakespeare_ckpt_latest_fig.png`
