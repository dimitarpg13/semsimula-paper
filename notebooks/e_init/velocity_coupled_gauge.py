...
md.append(
    ...
    "- Symmetric-but-non-Hessian extensions -- these are **outside** the "
    "Helmholtz framework but are what the $R^{2}$ data say is actually "
    "needed.  A Riemannian / Jacobi-geodesic formulation "
