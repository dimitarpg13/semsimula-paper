...
> Companion code latest release: **v4.4-zenodo** (May 24, 2026) — comprehensive source audit (498 labels, 320 refs, 44 figures, 89 citations all verified; 3 typo fixes: redundant "equation Equation", 3× "framework-of-record record"); rebuilt `semsimula_paper.pdf` (260 pages) and `semsimula_paper_source.zip` (82 files). Supersedes v4.3-zenodo (May 22, 2026).
...
The companion code archive at the v4.4-zenodo release has its own citable DOI:
