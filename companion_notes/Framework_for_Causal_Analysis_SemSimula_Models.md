...
`Fock-PARFLM_Causal_Leak_Audit_Results.md` into a reusable, semi-automated
...
- `Fock-PARFLM_Causal_Leak_Audit_Results.md` — the case study SCAF generalizes.
- `GitHub_Markdown_LaTeX_Rendering_Cheatsheet.md` — rendering rules used here.
- Prototype scripts: `notebooks/conservative_arch/scaleup/debug/`
  (`fock_causality_probe.py`, `fock_trained_leak_probe.py`,
